...
<div class="fn-meta"><b>Function path:</b> Audio System Basic Operation / Playing AM/FM Radio<br><b>Source:</b> printed page 287, 288, 289, 290<br><b>Test-ready:</b> <span class="test-ready-no">no — procedure missing or thresholds unfilled</span></div>
...
| 11 | <span class="req-label">Playing AM/FM Radio</span>To add a station: 1.Tune to the selected station. 2.Select and hold Press &amp; Hold to Add. | capability | p.288 / text |
...
| 5 | <span class="req-label">Playing AM/FM Radio</span>Lists the strongest stations on the selected band. 1.Select Station List to display a list. 2.Select the station. | capability | p.288 / text |
| 6 | <span class="req-label">Playing AM/FM Radio</span>Manual update. | capability | p.288 / text |
| 7 | <span class="req-label">Playing AM/FM Radio</span>Updates your available station list at any time. 1.Select Station List to display a list. 2.Select Refresh. | capability | p.288 / text |
...
| 14 | <span class="req-label">Playing AM/FM Radio</span>1.Select Station List to display a list while listening to an FM station. 2.Select the station. | capability | p.289 / text |
| 15 | <span class="req-label">Playing AM/FM Radio</span>Manual update. | capability | p.289 / text |
| 16 | <span class="req-label">Playing AM/FM Radio</span>Updates your available station list at any time. 1.Select Station List to display a list while listening to an FM station. 2.Select Refresh. | capability | p.289 / text |
...
| 18 | <span class="req-label">Playing AM/FM Radio</span>HD Subchannel. | capability | p.290 / text |
| 19 | <span class="req-label">Playing AM/FM Radio</span>Displays the subchannel list when an HD RadioTM station is selected while listening to an FM station. 1.Select Station List. 2.Select the channel number. | constraint | p.290 / text |
| 20 | <span class="req-label">Playing AM/FM Radio</span>AM/FM Settings. | capability | p.290 / text |
| 21 | <span class="req-label">Playing AM/FM Radio</span>Changes the AM/FM settings. 1.Select Menu. 2.Select an option. | capability | p.290 / text |
| 22 | <span class="req-label">Step -</span>HD Radio: Automatically choose a digital or an analog channel, or listen to analog only. | capability | p.290 / bullet |
| 23 | <span class="req-label">Step -</span>Artwork: Turns the artwork display on and off. | capability | p.290 / bullet |
