...
flowchart TD
    ...
    S1_4["4. Select Factory Data Reset. uA confirmation message appea…"]
    S1_5["5. Select Continue."]
    S1_6["6. Select Reset again to reset the settings. uThe system wi…"]
    S1_1 --> S1_2
    S1_2 --> S1_3
    S1_3 --> S1_4
    S1_4 --> S1_5
...
| 1 | 4 | Select Factory Data Reset. uA confirmation message appears on the screen. | p.368 / step |
| 1 | 5 | Select Continue. | p.368 / step |
| 1 | 6 | Select Reset again to reset the settings. uThe system will reboot. | p.368 / step |
...
| 5 | <span class="req-label">Defaulting All the Settings</span>Defaulting Vehicle Settings. | capability | p.368 / text |
| 6 | <span class="req-label">Defaulting All the Settings</span>1Defaulting All the Settings When you transfer the vehicle to a third-party, reset all settings to default and delete all personal data. | constraint | p.368 / text |
| 7 | <span class="req-label">Defaulting All the Settings</span>If you perform Factory Data Reset, it will reset the preinstalled apps to their factory default. | capability | p.368 / text |
| 8 | <span class="req-label">Defaulting All the Settings</span>If you perform Factory Data Reset, you cannot use the HondaLink® because it goes offline. 2 HondaLink® P.300. | constraint | p.368 / text |
