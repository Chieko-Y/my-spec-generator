<!-- GENERATED:START function=a0b97ebf358d (generated; edits inside this block are overwritten by the next publish — write your own notes outside it) -->
# 24. Audio Error Messages

<div class="fn-meta"><b>Function path:</b> Features / Audio Error Messages<br><b>Source:</b> printed page 324<br><b>Test-ready:</b> <span class="test-ready-no">no — procedure missing or thresholds unfilled</span></div>
