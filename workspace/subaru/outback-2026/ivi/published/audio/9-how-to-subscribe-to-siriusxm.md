...
|---|---|---|---|
| 1 | <span class="req-label">How to subscribe to SiriusXM®</span>To listen to a SiriusXM broadcast in the vehicle, a subscription to SiriusXM is required following any trial included with the purchase of your vehicle. | capability | p.96 / text |
| 2 | <span class="req-label">How to subscribe to SiriusXM®</span>SiriusXM is only available in the U.S. and Canada. | capability | p.96 / text |
| 3 | <span class="req-label">How to subscribe to SiriusXM®</span>How to subscribe. | capability | p.97 / text |
| 4 | <span class="req-label">How to subscribe to SiriusXM®</span>SiriusXM audio and infotainment services provided by Sirius XM Radio Inc. | capability | p.97 / text |
| 5 | <span class="req-label">How to subscribe to SiriusXM®</span>Trial Subscription Details: Your SiriusXM trial subscription will automatically stop at the end of your trial period. If you decide to purchase a subscription plan after your trial, your service will automatically renew in accordance with your selected plan and you will be charged according to your chosen payment method at the then-current rates, plus applicable fees and taxes. Services are subject to the SiriusXM Customer Agreement and Privacy Policy available at siriusxm.com (if in Canada, Siriusxm.ca) which includes complete terms and how to cancel. All fees, content and features are subject to change. | constraint | p.97 / text |

## 9-2-2. Service requirements

| # | Presumed requirement | Strength | Source |
|---|---|---|---|
| 1 | <span class="req-label">Step -</span>For more information on your SiriusXM service or to subscribe please refer to the following:. | capability | p.97 / bullet |
| 2 | <span class="req-label">How to subscribe to SiriusXM®</span>U.S.A. Refer to www.siriusxm.com or call To Subscribe: 1-877-447-0011. | capability | p.97 / text |
| 3 | <span class="req-label">How to subscribe to SiriusXM®</span>To Cancel: 1-866-635-2349. | capability | p.97 / text |
| 4 | <span class="req-label">How to subscribe to SiriusXM®</span>Canada 5 Refer to www.siriusxm.ca or call. | capability | p.97 / text |
| 5 | <span class="req-label">How to subscribe to SiriusXM®</span>To Subscribe/Cancel: 1-877-209-0079. | capability | p.97 / text |
| 6 | <span class="req-label">Step -</span>Explicit Language Notice — Channels with frequent explicit language are indicated with an “XL” preceding the channel name. Channel blocking is available for SiriusXM® receivers by notifying SiriusXM at; U.S.A. Customers: Visit www.siriusxm.com or calling 1-877-447-0011 Canadian Customers: Visit www.siriusxm.ca or calling 1-877-209-0079. | capability | p.97 / bullet |
