...
|---|---|---|---|
| 1 | <span class="req-label">Searching for a current content</span>A currently aired program can be searched for by keyword(s), such as channel number, category, team name, etc., using either voice recognition or on screen. To enable search, display the search screen. | capability | p.99 / text |
| 2 | <span class="req-label">Searching for a current content</span>Select the desired content from the search results list displayed. | capability | p.99 / text |
| 3 | <span class="req-label">Searching for a current content</span>Microphone. | capability | p.99 / text |

## 12-2-2. Service requirements

| # | Presumed requirement | Strength | Source |
|---|---|---|---|
| 1 | <span class="req-label">Step -</span>User’s speech is recognized by a built-in microphone. | capability | p.99 / bullet |
| 2 | <span class="req-label">Step -</span>Wait for the confirmation beep before speaking a command. | capability | p.100 / bullet |
| 3 | <span class="req-label">Step -</span>Spoken too quickly. | capability | p.100 / bullet |
| 4 | <span class="req-label">Step -</span>Spoken at a low or high volume. | capability | p.100 / bullet |
| 5 | <span class="req-label">Step -</span>Driving with a window open. | capability | p.100 / bullet |
| 6 | <span class="req-label">Step -</span>The air conditioning speed is set high. | capability | p.100 / bullet |
...
| # | Presumed requirement | Strength | Source |
|---|---|---|---|
| 1 | <span class="req-label">Step -</span>Passengers are talking while voice commands are spoken. | capability | p.100 / bullet |
