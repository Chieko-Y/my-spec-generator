...
|---|---|---|---|
| 1 | <span class="req-label">Step -</span>Turn on the power of the device if it is not turned on. | constraint | p.30 / bullet |
| 2 | <span class="req-label">Step -</span>Compatible USB memory device: →P.113. | capability | p.30 / bullet |
