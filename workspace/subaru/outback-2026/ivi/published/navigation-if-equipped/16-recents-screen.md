...
|---|---|---|---|
| 1 | <span class="req-label">Recents screen</span>Displays a list of recent destinations. | capability | p.130 / text |
| 2 | <span class="req-label">Recents screen</span>List of past destinations Select to display the destination information screen. (→P.127). | capability | p.131 / text |
| 3 | <span class="req-label">Recents screen</span>Select to edit the list of past destinations. | capability | p.131 / text |
