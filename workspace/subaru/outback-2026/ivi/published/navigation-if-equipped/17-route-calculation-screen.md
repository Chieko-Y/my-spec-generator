...
|---|---|---|---|
| 1 | <span class="req-label">Route calculation screen</span>On the route calculation screen, searched routes can be viewed. Routes can be changed before route guidance begins by changing the calculation conditions. | capability | p.131 / text |
| 2 | <span class="req-label">Route calculation screen</span>Candidate routes (max. 3 routes). | capability | p.132 / text |
