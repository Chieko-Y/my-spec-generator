...
|---|---|---|---|
| 1 | <span class="req-label">Typical voice guidance prompts</span>As the vehicle approaches an intersection, or point, where maneuvering the vehicle is necessary, the system’s voice guidance will provide various messages. | capability | p.134 / text |

## 19-2-2. Service requirements

| # | Presumed requirement | Strength | Source |
|---|---|---|---|
| 1 | <span class="req-label">Step -</span>To adjust the voice guidance volume: →P.41. | capability | p.135 / bullet |
| 2 | <span class="req-label">Step -</span>Setting voice guidance: →P.119. | capability | p.135 / bullet |
| 3 | <span class="req-label">Step -</span>Voice guidance may be made early or late. | capability | p.135 / bullet |
