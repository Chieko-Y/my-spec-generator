...
flowchart LR
    ...
    A1 --> A1F1["1 Introduction ⚠"]
    A1 --> A1F2["2 Read first ⚠"]
    A1 --> A1F3["3 Symbols used in illustrations ⚠"]
    A1 --> A1F4["4 Precautions for use ⚠"]
    A1 --> A1F5["5 When transferring ownership of the vehicle ⚠"]
    A1 --> A1F6["6 Safety instruction ⚠"]
    A1 --> A1F7["7 How to read this manual ⚠"]
    A1 --> A1F8["8 Pictorial index ⚠"]
```
