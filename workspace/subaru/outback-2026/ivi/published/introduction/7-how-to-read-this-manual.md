...
|---|---|---|---|
| 1 | <span class="req-label">How to read this manual</span>No. Name Description Operational outlines An outline of the operation is explained. Main operations The steps of an operation are explained. Describes supplemental information relating to main Supplemental information operation. | capability | p.12 / text |
