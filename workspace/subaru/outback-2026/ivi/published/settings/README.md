...
flowchart LR
    ...
    ROOT --> A1["Settings"]
    A1 --> A1F1["1 Displaying the settings screen"]
    A1 --> A1F2["2 Sound settings screen"]
    A1 --> A1F3["3 Equalizer settings ⚠"]
    A1 --> A1F4["4 Balance/fader settings ⚠"]
    A1 --> A1F5["5 Manage devices settings screen"]
    A1 --> A1F6["6 Displays settings screen"]
    A1 --> A1F7["7 Phone settings screen"]
    A1 --> A1F8["8 Editing the quick reply message"]
    A1 --> A1F9["9 Network connection settings screen"]
    A1 --> A1F10["10 Software settings screen"]
    A1 --> A1F11["11 Updating the Subaru connected services system ⚠"]
    A1 --> A1F12["12 Download update ⚠"]
    A1 --> A1F13["13 Update installation"]
    A1 --> A1F14["14 Updating the vehicle’s systems other than the Subaru con…"]
    A1 --> A1F15["15 Download update"]
    A1 --> A1F16["16 Update installation"]
```
