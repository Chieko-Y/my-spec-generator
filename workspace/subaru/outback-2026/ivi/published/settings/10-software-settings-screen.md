...
<div class="fn-meta"><b>Function path:</b> Settings / Software settings screen<br><b>Source:</b> printed page 48, 49<br><b>Test-ready:</b> <span class="test-ready-yes">yes — no unfilled thresholds and a procedure is present</span></div>
...
| # | Presumed requirement | Strength | Source |
|---|---|---|---|
| 1 | <span class="req-label">Step -</span>To use the services using the cloud navigation server, “Location Based Cloud Services”* it is necessary to enable the setting. | capability | p.48 / bullet |
| 2 | <span class="req-label">Step -</span>When the services using the cloud navigation server are not to be used, disable the settings, check the message displayed and then touch “Continue”. | capability | p.48 / bullet |
