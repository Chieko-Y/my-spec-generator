...
|---|---|---|---|
| 1 | <span class="req-label">Functions available using a Bluetooth phone</span>Registering a Bluetooth phone/device: →P.55. | capability | p.75 / text |
| 2 | <span class="req-label">Functions available using a Bluetooth phone</span>Calling on the Bluetooth phone: →P.78 Phone operation Receiving on the Bluetooth phone: →P.81. | capability | p.75 / text |
