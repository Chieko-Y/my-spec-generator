...
|---|---|---|---|
| 1 | <span class="req-label">By favorites list</span>Calls can be made to contacts registered as favorites of the connected Bluetooth phone. | capability | p.79 / text |
