<!-- GENERATED:START function=0741d348047c (generated; edits inside this block are overwritten by the next publish — write your own notes outside it) -->
# 14. Call waiting
...
![figure](../figures/FIG-e72ea39a3fa4.png)
- Figure 14-1 source: p.82
- (Copied from OM) ● The first call is put on hold.
![figure](../figures/FIG-82f7fe5b6fec.png)
...
```mermaid
flowchart TD
    S1["1. Touch “Accept” or press the"]
    S2["2. Check that the call waiting screen is"]
    S1 --> S2
```

| Seq | Step | Operation (Copied from OM) | Source |
|---|---|---|---|
| 1 | 1 | Touch “Accept” or press the | p.82 / step |
| 2 | 2 | Check that the call waiting screen is | p.83 / step |
...
| 2 | <span class="req-label">Call waiting</span>switch on the steering wheel to start talking with the other party. | capability | p.82 / text |
...
| 2 | <span class="req-label">Call waiting</span>displayed. | capability | p.83 / text |
| 3 | <span class="req-label">Step -</span>“Swap”: Select to change parties. Each time “Swap” or name area is selected, or press the switch on the steering wheel, the party who is on hold will be switched. | capability | p.83 / bullet |
| 4 | <span class="req-label">Step -</span>Touch “Merge” or press and hold the switch on the steering wheel to change to a conference call.*. | capability | p.83 / bullet |
| 5 | <span class="req-label">Step -</span>Touch “End” or press the switch on the steering wheel to end the call and return to the conversation with the party on hold when having a two-way conversation, and to end the call with both parties when having a three-way conversation. | constraint | p.83 / bullet |
...
<!-- GENERATED:END function=0741d348047c -->
