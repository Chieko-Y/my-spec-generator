...
flowchart TD
    ...
    S1_2["2. Touch “Contacts”, and then select the desired contact."]
...
| 1 | 2 | Touch “Contacts”, and then select the desired contact. | p.80 / step |
| 1 | 3 | Touch “[icon]” next to the desired number. | p.80 / step |

## 11-2-1. Service overview

| # | Presumed requirement | Strength | Source |
|---|---|---|---|
| 1 | <span class="req-label">By contacts list</span>Calls can be made by using contact data which is downloaded from the connected Bluetooth phone. | capability | p.80 / text |

## 11-2-2. Service requirements

| # | Presumed requirement | Strength | Source |
|---|---|---|---|
| 1 | <span class="req-label">Step -</span>Numbers may include home, work, mobile and other as categories depending on the phonebook data of the connected cellular phone. | capability | p.80 / bullet |
| 2 | <span class="req-label">Step -</span>The outgoing call screen is displayed. | capability | p.80 / bullet |
