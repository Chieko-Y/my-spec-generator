...
```mermaid
flowchart LR
    ROOT["Subaru Outback 2025 — quick-guide"]
    ROOT --> A1["Quick Guide"]
    A1 --> A1F1["1 Button Overview ⚠"]
    A1 --> A1F2["2 Home Screen ⚠"]
    A1 --> A1F3["3 Car Information/Climate Control Screen ⚠"]
    A1 --> A1F4["4 With A Bluetooth Phone/Device ⚠"]
    A1 --> A1F5["5 Adding A Bluetooth Phone/Device ⚠"]
    A1 --> A1F6["6 Create A Driver Profile ⚠"]
    A1 --> A1F7["7 Phone Screen ⚠"]
    A1 --> A1F8["8 Apps Screen ⚠"]
    A1 --> A1F9["9 Radio Screen ⚠"]
    A1 --> A1F10["10 Useful SiriusXM® Radio Functions ⚠"]
    A1 --> A1F11["11 Media Screen ⚠"]
    A1 --> A1F12["12 Loading And Unloading A Disc ⚠"]
    A1 --> A1F13["13 Portable Device ⚠"]
    A1 --> A1F14["14 Settings Screen ⚠"]
    A1 --> A1F15["15 Steering Wheel Controls ⚠"]
    A1 --> A1F16["16 Overview ⚠"]
    A1 --> A1F17["17 Home Screen ⚠"]
    A1 --> A1F18["18 With A Bluetooth Phone/Device ⚠"]
    A1 --> A1F19["19 Managing A Bluetooth Phone/Device ⚠"]
    A1 --> A1F20["20 Create A Driver Profile ⚠"]
    A1 --> A1F21["21 Car Information Screen ⚠"]
    A1 --> A1F22["22 Phone Screen ⚠"]
    A1 --> A1F23["23 Map Screen  ⚠"]
    A1 --> A1F24["24 Radio Screen ⚠"]
    A1 --> A1F25["25 Useful SiriusXM® Radio Functions ⚠"]
    A1 --> A1F26["26 Media Screen ⚠"]
    A1 --> A1F27["27 Loading And Unloading A Disc ⚠"]
    A1 --> A1F28["28 Portable Device ⚠"]
    A1 --> A1F29["29 Apps Screen ⚠"]
    A1 --> A1F30["30 Settings Screen ⚠"]
    A1 --> A1F31["31 Steering Wheel Controls ⚠"]
```
