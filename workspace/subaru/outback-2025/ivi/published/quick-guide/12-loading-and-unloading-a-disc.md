...
<div class="fn-meta"><b>Function path:</b> Quick Guide / Loading And Unloading A Disc<br><b>Source:</b> printed page 35<br><b>Test-ready:</b> <span class="test-ready-no">no — procedure missing or thresholds unfilled</span></div>
...
|---|---|---|---|
| 1 | <span class="req-label">Loading And Unloading A Disc</span>Loading a disc. | capability | p.35 / text |
| 2 | <span class="req-label">Loading And Unloading A Disc</span>Insert the disc with the label side facing the rear of the vehicle. | capability | p.35 / text |
| 3 | <span class="req-label">Loading And Unloading A Disc</span>- Operation Flow: Using Playback Modes -. | capability | p.35 / text |
