<!-- GENERATED:START function=3d7c69f19b0d (generated; edits inside this block are overwritten by the next publish — write your own notes outside it) -->
# 4. Current Position Display

<div class="fn-meta"><b>Function path:</b> Navigation System (If equipped) / Current Position Display<br><b>Source:</b> printed page 197<br><b>Test-ready:</b> <span class="test-ready-no">no — procedure missing or thresholds unfilled</span></div>
...
|---|---|---|---|---|---|---|---|
| f6da51b12752 | a certain amount of time | quantity | as stated | **unfilled** | unfilled | — | — |
