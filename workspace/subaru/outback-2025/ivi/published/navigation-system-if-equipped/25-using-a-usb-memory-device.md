...
flowchart TD
    ...
    direction TB
    S1_1["1. Connect to a USB memory device. (→P.70)"]
    ...
    direction TB
    S2_1["1. Connect to a Wi-Fi® network. (→P.96)"]
...
| 2 | <span class="req-label">Using A USB Memory Device</span>The map data may also be updated via Wi-Fi® network. | capability | p.225 / text |
