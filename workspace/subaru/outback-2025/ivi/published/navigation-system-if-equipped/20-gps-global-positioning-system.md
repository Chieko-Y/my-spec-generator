<!-- GENERATED:START function=880995ff676b (generated; edits inside this block are overwritten by the next publish — write your own notes outside it) -->
# 20. GPS (Global Positioning System)

<div class="fn-meta"><b>Function path:</b> Navigation System (If equipped) / GPS (Global Positioning System)<br><b>Source:</b> printed page 221<br><b>Test-ready:</b> <span class="test-ready-no">no — procedure missing or thresholds unfilled</span></div>
...
|---|---|---|---|
| 1 | <span class="req-label">GPS (Global Positioning System)</span>REGARDING ERRORS IN CURRENT POSITION DISPLAY. | capability | p.221 / text |
...
<!-- GENERATED:END function=880995ff676b -->
