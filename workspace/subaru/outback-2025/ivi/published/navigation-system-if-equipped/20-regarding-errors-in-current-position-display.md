<!-- GENERATED:START function=e7306d81091e (generated; edits inside this block are overwritten by the next publish — write your own notes outside it) -->
# 20. Regarding Errors In Current Position Display

<div class="fn-meta"><b>Function path:</b> Navigation System (If equipped) / Regarding Errors In Current Position Display<br><b>Source:</b> printed page 221<br><b>Test-ready:</b> <span class="test-ready-no">no — procedure missing or thresholds unfilled</span></div>
