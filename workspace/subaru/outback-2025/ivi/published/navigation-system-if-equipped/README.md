...
flowchart LR
    ...
    A1 --> A1F3["3 Map Screen Buttons Overview ⚠"]
    A1 --> A1F4["4 Current Position Display ⚠"]
    A1 --> A1F5["5 Location Menu Pop-up"]
    A1 --> A1F6["6 Orientation Of The Map"]
    A1 --> A1F7["7 Gas Station/Parking Lot/Rest Area Icons ⚠"]
    A1 --> A1F8["8 Other Information ⚠"]
    A1 --> A1F9["9 Main Menu Screen Overview"]
    A1 --> A1F10["10 Search Screen ⚠"]
    A1 --> A1F11["11 Favorites Screen"]
    A1 --> A1F12["12 Edit List Screen ⚠"]
    A1 --> A1F13["13 Route Calculation Screen ⚠"]
    A1 --> A1F14["14 Route Guidance Screen ⚠"]
    A1 --> A1F15["15 Current Route Screen"]
    A1 --> A1F16["16 Standard Map Icon ⚠"]
    ...
    A1 --> A1F24["24 SUBARU Map Update ⚠"]
    A1 --> A1F25["25 Using A USB Memory Device"]
    A1 --> A1F26["26 Using Wi-Fi®"]
```
...
| 11 | [Favorites Screen](/specifications/subaru/outback-2025/ivi/file/11-favorites-screen.md?chapter=navigation-system-if-equipped) | Navigation System (If equipped) | 15 | 2 | 0 | o |
...
| 20 | [Regarding Errors In Current Position Display](/specifications/subaru/outback-2025/ivi/file/20-regarding-errors-in-current-position-display.md?chapter=navigation-system-if-equipped) | Navigation System (If equipped) | 1 | 0 | 0 | - |
